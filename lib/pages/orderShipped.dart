...
class _orderShipState extends State<orderShip> {
  ...
  late String shipName = widget.data['shipName'];
  late String shipId = widget.data['shipId'];
  late String shipLink = widget.data['shipLink'];
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    // Use GestureDetector if you prefer
                                    onTap: () async {
                                      _copyToClipboard(shipId);
                                      // Make sure shipLink is the URL you want to open
                                    },
                                    child: Text(
                                      shipId, // Assuming shipId is a TextEditingController
                                      style: GoogleFonts.inter(
                                        fontSize: w * 0.035,
                                        fontWeight: FontWeight.w300,
                                        color: AppColors.secondaryColor,
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      _copyToClipboard(
                                          shipLink); // Make sure shipLink is the URL you want to open
                                    },
                                    child: Container(
                                      width: w * 0.5,
                                      child: SingleChildScrollView(
                                        ...
                                        child: Text(
                                          shipLink, // Assuming shipId is a TextEditingController
                                          style: GoogleFonts.inter(
                                            fontSize: w * 0.035,
                                            fontWeight: FontWeight.w300,
                                            color: AppColors.secondaryColor,
